# Public Key
Represents a QTUM public key and is needed to be able to receive QTUM, as is usually represented as a QTUM [Address](address.md). See the official [QTUM Wiki](https://en.bitcoin.it/wiki/Technical_background_of_version_1_Bitcoin_addresses).
