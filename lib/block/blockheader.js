...
/**
 * @returns {Buffer} - A hash Buffer of the BlockHeader
 */
BlockHeader.prototype.toHashBuffer = function toBuffer() {
 ...
 * @returns {BufferWriter} - An instance of BufferWriter representation of the hash BlockHeader
 */
BlockHeader.prototype.toHashBufferWriter = function toBufferWriter(bw) {
    if (!bw) {
        bw = new BufferWriter();
    }
